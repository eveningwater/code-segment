...
<div class="code-editor" data-url="codes/javascript/ts/replace-last.ts" data-language="typescript"></div>
...
以下是一个实战<a href="codes/javascript/html/replace-last.html" target="_blank" rel="noopener noreferrer">示例</a>:

<div class="code-editor" data-url="codes/javascript/html/replace-last.html" data-language="html"></div>

结果如下:

<iframe src="codes/javascript/html/replace-last.html"></iframe>